...
export enum HttpStatusCodeEnum {
    ...
    /**
     * Essa resposta é enviada quando o servidor da Web após realizar a 
     * negociação de conteúdo orientada pelo servidor, não encontra nenhum 
     * conteúdo seguindo os critérios fornecidos pelo agente do usuário.
     */
    NOT_ACCEPTABLE = 406,
